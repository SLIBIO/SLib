...
Ref<AudioRecorder> DirectSound_AudioRecorder::create(const AudioRecorderParam& param)
{
	return Ref<AudioRecorder>::from(_DirectSound_AudioRecorder::create(param));
}

List<AudioDeviceInfo> DirectSound_AudioRecorder::getDevicesList()
{
...
Ref<AudioPlayer> DirectSound_AudioPlayer::create(const AudioPlayerParam& param)
{
	return Ref<AudioPlayer>::from(_DirectSound_AudioPlayer::create(param));
}

List<AudioDeviceInfo> DirectSound_AudioPlayer::getDevicesList()
{
	List<AudioDeviceInfo> ret;
