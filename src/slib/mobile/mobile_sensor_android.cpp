...
#include "../../../inc/slib/mobile/sensor.h"
...
SLIB_JNI_BEGIN_CLASS(_JAndroidSensors, "slib/platform/android/mobile/Sensors")
	SLIB_JNI_STATIC_METHOD(create, "create", "(Landroid/app/Activity;)Lslib/platform/android/mobile/Sensors;");
