...
@
    ...
    .global vp8_loop_filter_horizontal_edge_armv6 
	.type vp8_loop_filter_horizontal_edge_armv6, function
    .global vp8_mbloop_filter_horizontal_edge_armv6 
	.type vp8_mbloop_filter_horizontal_edge_armv6, function
    .global vp8_loop_filter_vertical_edge_armv6 
	.type vp8_loop_filter_vertical_edge_armv6, function
    .global vp8_mbloop_filter_vertical_edge_armv6 
	.type vp8_mbloop_filter_vertical_edge_armv6, function

.text
.p2align 2@ name this block of code

.macro    TRANSPOSE_MATRIX a0, a1, a2, a3, b0, b1, b2, b3
...
@-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
_vp8_loop_filter_horizontal_edge_armv6:
...
_hskip_filter:
    ...
    add         sp, sp, #16
    ldmia       sp!, {r4 - r11, pc}
	.size vp8_loop_filter_horizontal_edge_armv6, .-vp8_loop_filter_horizontal_edge_armv6    @ ENDP        @ |vp8_loop_filter_horizontal_edge_armv6|


@-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
_vp8_mbloop_filter_horizontal_edge_armv6:
...
_mbhskip_filter:
    ...
    add         sp, sp, #16
    ldmia       sp!, {r4 - r11, pc}
	.size vp8_mbloop_filter_horizontal_edge_armv6, .-vp8_mbloop_filter_horizontal_edge_armv6    @ ENDP        @ |vp8_mbloop_filter_horizontal_edge_armv6|


@-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
_vp8_loop_filter_vertical_edge_armv6:
...
_vskip_filter:
    ...
    ldmia       sp!, {r4 - r11, pc}
	.size vp8_loop_filter_vertical_edge_armv6, .-vp8_loop_filter_vertical_edge_armv6    @ ENDP        @ |vp8_loop_filter_vertical_edge_armv6|



@-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
_vp8_mbloop_filter_vertical_edge_armv6:
...
_mbvskip_filter:
    ...
    ldmia       sp!, {r4 - r11, pc}
	.size vp8_mbloop_filter_vertical_edge_armv6, .-vp8_mbloop_filter_vertical_edge_armv6    @ ENDP        @ |vp8_mbloop_filter_vertical_edge_armv6|
