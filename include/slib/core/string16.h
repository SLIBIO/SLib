...
namespace slib
{
	...
	public:
		 ...
		 */
		String16(const char* strUtf8, sl_reg length);
		 ...
		 */
		String16(const wchar_t* strUnicode);
		 ...
		 */
		String16(const wchar_t* strUnicode, sl_reg length);
		 ...
		 */
		String16(const char16_t* strUtf16);
		 ...
		 */
		String16(const char16_t* strUtf16, sl_reg length);
		 ...
		 */
		String16(const char32_t* strUtf32);
		 ...
		 */
		String16(const char32_t* strUtf32, sl_reg length);
	...
	public:
		 ...
		 * String16 assignment
		 */
		String16& operator=(const char* utf8);
		
		/**
		 * String16 assignment
		 */
		String16& operator=(const wchar_t* sz);

		/**
		 * String16 assignment
		 */
		String16& operator=(const char16_t* utf16);
		
		/**
		 * String16 assignment
		 */
		String16& operator=(const char32_t* utf32);
	...
	public:
		 ...
		 * AtomicString16 assignment
		 */
		AtomicString16& operator=(const char* utf8);
		
		/**
		 * AtomicString16 assignment
		 */
		AtomicString16& operator=(const wchar_t* sz);

		/**
		 * AtomicString16 assignment
		 */
		AtomicString16& operator=(const char16_t* utf16);
		
		/**
		 * AtomicString16 assignment
		 */
		AtomicString16& operator=(const char32_t* utf32);
