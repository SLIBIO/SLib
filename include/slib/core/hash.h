...
namespace slib
{
	...
	constexpr sl_uint32 Rehash(sl_uint32 x)
	{
		return x ^ (x >> 4) ^ (x >> 7) ^ (x >> 12) ^ (x >> 16) ^ (x >> 19) ^ (x >> 20) ^ (x >> 24) ^ (x >> 27);
	}

	constexpr sl_uint32 Hash64(sl_uint64 x)
	{
	...
	{
	public:
		constexpr sl_uint32 operator()(char v) const { return Rehash(v);}
	};
	...
	{
	public:
		constexpr sl_uint32 operator()(unsigned char v) const { return Rehash(v);}
	};
	...
	{
	public:
		constexpr sl_uint32 operator()(short v) const { return Rehash(v);}
	};
	...
	{
	public:
		constexpr sl_uint32 operator()(unsigned short v) const { return Rehash(v);}
	};
	...
	{
	public:
		constexpr sl_uint32 operator()(int v) const { return Rehash(v);}
	};
	...
	{
	public:
		constexpr sl_uint32 operator()(unsigned int v) const { return Rehash(v);}
	};
	...
	{
	public:
		constexpr sl_uint32 operator()(long v) const { return Rehash((sl_uint32)v);}
	};
	...
	{
	public:
		constexpr sl_uint32 operator()(unsigned long v) const { return Rehash((sl_uint32)v);}
	};
	...
	{
	public:
		constexpr sl_uint32 operator()(sl_int64 v) const { return Hash64(v); }
	};
	...
	{
	public:
		constexpr sl_uint32 operator()(sl_uint64 v) const { return Hash64(v); }
	};
