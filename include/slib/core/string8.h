...
namespace slib
{
	...
	public:
		 ...
		 */
		static String makeHexString(const void* data, sl_size size) noexcept;
		 ...
		 */
		static String makeHexString(const Memory& mem) noexcept;
	...
	{
	public:
		sl_uint32 operator()(const String& a) const noexcept;
	};
	...
	{
	public:
		sl_uint32 operator()(const AtomicString& a) const noexcept;
	};
	...
	{
	public:
		sl_uint32 operator()(const String& v) const noexcept;
