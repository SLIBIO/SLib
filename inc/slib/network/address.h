#ifndef CHECKHEADER_SLIB_NETWORK_ADDRESS
#define CHECKHEADER_SLIB_NETWORK_ADDRESS
...
class SLIB_EXPORT NetworkDevice
{
public:
	String name;
	String displayName;
...
public:
	sl_bool findDevice(const String& nameOrDisplayName);

public:
	static List<NetworkDevice> findAllDevices();
...
class SLIB_EXPORT NetworkAddress
{
public:
