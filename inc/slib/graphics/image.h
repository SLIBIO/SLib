...
public:
	static void draw(ImageDesc& dst, const ImageDesc& src, BlendMode blend = blendCopy, StretchMode stretch = stretchHalftone);
	...
	void drawImage(sl_int32 dx, sl_int32 dy, sl_int32 dw, sl_int32 dh
		...
		, BlendMode blend = blendCopy, StretchMode stretch = stretchHalftone);
	...
	Ref<Image> scale(sl_uint32 width, sl_uint32 height, StretchMode stretch = stretchHalftone) const;
