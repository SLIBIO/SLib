...
public:
	...
	SLIB_INLINE Size getStringExtent(const String8& _text)
	{
		String16 text = _text;
		return getStringExtent(text.getBuf(), text.getLength());
	}
	SLIB_INLINE Size getStringExtent(const String16& _text)
	{
		String16 text = _text;
		return getStringExtent(text.getBuf(), text.getLength());
	}
	...
	SLIB_INLINE void drawString(const Ref<Image>& imageOutput, sl_int32 x, sl_int32 y, const String8& _text, const Color& color)
	{
		String16 text = _text;
		return drawString(imageOutput, x, y, text.getBuf(), text.getLength(), color);
	}
	SLIB_INLINE void drawString(const Ref<Image>& imageOutput, sl_int32 x, sl_int32 y, const String16& _text, const Color& color)
	{
		String16 text = _text;
		return drawString(imageOutput, x, y, text.getBuf(), text.getLength(), color);
	}
	...
	SLIB_INLINE void strokeString(const Ref<Image>& imageOutput, sl_int32 x, sl_int32 y, const String8& _text, const Color& color, sl_uint32 lineWidth)
	{
		String16 text = _text;
		return strokeString(imageOutput, x, y, text.getBuf(), text.getLength(), color, lineWidth);
	}
	SLIB_INLINE void strokeString(const Ref<Image>& imageOutput, sl_int32 x, sl_int32 y, const String16& _text, const Color& color, sl_uint32 lineWidth)
	{
		String16 text = _text;
		return strokeString(imageOutput, x, y, text.getBuf(), text.getLength(), color, lineWidth);
	}
	...
	SLIB_INLINE void strokeStringInside(const Ref<Image>& imageOutput, sl_int32 x, sl_int32 y, const String8& _text, const Color& color, sl_uint32 lineWidth)
	{
		String16 text = _text;
		return strokeStringInside(imageOutput, x, y, text.getBuf(), text.getLength(), color, lineWidth);
	}
	SLIB_INLINE void strokeStringInside(const Ref<Image>& imageOutput, sl_int32 x, sl_int32 y, const String16& _text, const Color& color, sl_uint32 lineWidth)
	{
		String16 text = _text;
		return strokeStringInside(imageOutput, x, y, text.getBuf(), text.getLength(), color, lineWidth);
	}
	...
	SLIB_INLINE void strokeStringOutside(const Ref<Image>& imageOutput, sl_int32 x, sl_int32 y, const String8& _text, const Color& color, sl_uint32 lineWidth)
	{
		String16 text = _text;
		return strokeString(imageOutput, x, y, text.getBuf(), text.getLength(), color, lineWidth);
	}
	SLIB_INLINE void strokeStringOutside(const Ref<Image>& imageOutput, sl_int32 x, sl_int32 y, const String16& _text, const Color& color, sl_uint32 lineWidth)
	{
		String16 text = _text;
		return strokeString(imageOutput, x, y, text.getBuf(), text.getLength(), color, lineWidth);
	}
...
public:
	static Ref<FreeType> loadFromMemory(const Memory& _mem, sl_uint32 indexFace = 0);
