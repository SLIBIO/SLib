...
public:
	...
	static sl_uint32 createTexture2D(sl_uint32 width, sl_uint32 height, ColorModel colorModel, const void* pixels = sl_null, sl_uint32 pitch = 0);
	static sl_uint32 createTexture2D(sl_uint32 width, sl_uint32 height, const Color* pixels = sl_null, sl_uint32 stride = 0);
	...
	static void updateTexture2D(sl_uint32 x, sl_uint32 y, sl_uint32 width, sl_uint32 height, ColorModel colorModel, const void* pixels, sl_uint32 pitch);
	static void updateTexture2D(sl_uint32 x, sl_uint32 y, sl_uint32 width, sl_uint32 height, const Color* pixels, sl_uint32 stride);
	...
	static void setTexture2DFilterMode(Texture::FilterMode minFilter, Texture::FilterMode magFilter);
	static void setTexture2DWrapMode(Texture::WrapMode wrapX, Texture::WrapMode wrapY);
