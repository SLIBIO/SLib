...
#ifndef VPX_VPX_CODEC_COMMON1_H_
#define  VPX_VPX_CODEC_COMMON1_H_
...
#define VPX_CODEC_CAP_ENCODER 0x2 /**< Is an encoder */
   ...
   */
#ifndef VPX_VPX_CODEC_COMMON2_H_
#define VPX_VPX_CODEC_COMMON2_H_
...
#    define vpx_codec_control(ctx,id,data) vpx_codec_control_##id(ctx,id,data)\
   ...
   * function.
   */
#ifndef VPX_VPX_CODEC_COMMON3_H_
#define VPX_VPX_CODEC_COMMON3_H_
#    define VPX_CTRL_USE_TYPE(id, typ) \
